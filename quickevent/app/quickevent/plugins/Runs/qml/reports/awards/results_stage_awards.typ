// General award diploma template (Typst).
// Data is injected as data.json: one object per diploma with the keys produced by
// AwardTypstRenderer::collectRunsPages (eventName, date, place, positionCategory,
// competitorName, clubName, mainReferee, director, ...).
...
#for (i, page) in pages.enumerate() [
	...
	#v(14mm)
	#text(size: 18pt, weight: "bold")[#page.at("competitorName", default: "")]
	#v(3mm)
	#text(size: 14pt)[#page.at("positionCategory", default: "")]
	#v(2mm)
	#text(size: 13pt)[#page.at("clubName", default: "")]
